...
export const getdriverAuto = pt_id => async dispatch => {
        console.log(pt_id);
      const res=  await axios.get(`http://localhost:8081/cbs/driver/viewDriver/1`);
...
export const getdriverMini = pt_id => async dispatch => {
    console.log(pt_id);
  const res=  await axios.get(`http://localhost:8081/cbs/driver/viewDriver/2`);
...
export const getdriverPrime = pt_id => async dispatch => {
    console.log(pt_id);
  const res=  await axios.get(`http://localhost:8081/cbs/driver/viewDriver/3`);
