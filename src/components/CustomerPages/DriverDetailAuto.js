 ...
 class DriverDetailAuto extends Component {
    ...
    render() {
        ...
        return (
            ...
            <hr class="my-4"></hr>
            <p className="display-4 text-center"><h3 >Driver Name:-{driverauto.name}</h3></p>
            <p className="display-4 text-center"><h3 >Licence Number:-{driverauto.licenceNo}</h3></p>
            <p className="display-4 text-center"><h3 >Mobile Number:-{driverauto.mobileNumber}</h3></p>
        
            <Link to={"/finaltripauto"}>
