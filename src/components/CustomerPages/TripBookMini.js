                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="right">{trip.bill+30}rs</td>
                        <td class="right">{trip.bill+30}rs</td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <table class="table table-clear">
                      <tbody>
                        <tr>
                          ...
                          <td class="right">
                            <strong class="text1-dark1">{trip.bill+30}rs</strong>
                          </td>
                        </tr>
                      </tbody>
                    </table>
...
TripBookMini.propTypes = {
  trip: PropTypes.object.isRequired,
  getTripstablemini: PropTypes.func.isRequired,
};
const mapStateToProps = (state) => ({
  trip: state.trip,
});

export default connect(mapStateToProps, { getTripstablemini })(TripBookMini);
