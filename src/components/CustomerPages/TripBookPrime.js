...
import { getTripstableprime } from '../../actions/TripTableAction';

 class TripBookPrime extends Component {
  componentDidMount() {
    this.props.getTripstableprime();
  }
...
TripBookPrime.propTypes = {
  trip: PropTypes.object.isRequired,
  getTripstableprime: PropTypes.func.isRequired,
};
const mapStateToProps = (state) => ({
  trip: state.trip,
});

export default connect(mapStateToProps, { getTripstableprime })(TripBookPrime);
